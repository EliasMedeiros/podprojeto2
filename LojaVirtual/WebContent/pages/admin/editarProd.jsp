				...
				<div id="formNovoProd">
					...
					<table>
						...
						<tr>
							...
							<td><textarea name="descricaoProd" id="descricaoProd" cols="50" rows="5" maxlength="245" onkeydown="limitText(this, 245)" onkeyup="limitText(this, 245">${produtoDetalhes.descrição }</textarea></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
